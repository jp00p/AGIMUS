...
CREATE TABLE IF NOT EXISTS poshimodae (
  ...
  defense VARCHAR(64) NOT NULL DEFAULT 0,
  special_attack VARCHAR(64) NOT NULL DEFAULT 0,
  special_defense VARCHAR(64) NOT NULL DEFAULT 0,
  speed VARCHAR(64) NOT NULL DEFAULT 0,
