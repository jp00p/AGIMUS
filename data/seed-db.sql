...
CREATE TABLE IF NOT EXISTS poshimodae (
  ...
  base_attack INT(11) NOT NULL DEFAULT 0,
  base_defense INT(11) NOT NULL DEFAULT 0,
  base_special_attack INT(11) NOT NULL DEFAULT 0,
  base_special_defense INT(11) NOT NULL DEFAULT 0,
  base_speed INT(11) NOT NULL DEFAULT 0,
