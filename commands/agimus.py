...
async def agimus(message:discord.Message):
  announcement_channel_id = get_channel_id("bosuns-whistle")
  ...
  await message.reply(
    ...
    ).set_footer(text="You are talking to a pre-recorded message.")
  )

# NOTE: THIS COMMAND IS BEING DEPRECATED SHORTLY
# We have decided due to ethical concerns to remove the OpenAI AGIMUS Integration
# This file and references to it will be removed in the near future
