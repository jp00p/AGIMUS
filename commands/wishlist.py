...
async def add_autocomplete(ctx:discord.AutocompleteContext):
  ...
  filtered_badges = [
    ...
    b['badge_name'] for b in db_get_user_badges(ctx.interaction.user.id)
  ...
  filtered_badge_names = [badge['badge_name'] for badge in all_badge_info if badge['badge_name'] not in filtered_badges]
