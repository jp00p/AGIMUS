...
class PatternBufferDropdown(discord.ui.Select):
  ...
  async def callback(self, interaction: discord.Interaction):
    ...
    if selection == 'Enable Pattern Buffer DM':
      ...
      await db_toggle_pattern_buffer(interaction.user.id, False)
      await interaction.response.send_message(
        embed=discord.Embed(
...
class Settings(commands.Cog):
  ...
  async def _get_home_embed_and_thumbnail(self):
    ...
    embed = discord.Embed(
      ...
      description=(
        ...
        'For more details on what AGIMUS can do, try using `/help` in any channel. Channel-specific functionality '
        'will also be displayed if used within The Promenade channels.'
      ),
  ...
  async def _get_xp_embed_and_thumbnail(self):
    ...
    embed.set_thumbnail(url='attachment://xp_system.png')
  ...
  async def _get_crystallize_embed_and_thumbnail(self):
    ...
    embed.set_thumbnail(url='attachment://crystallization.png')
  ...
  async def _get_notifications_embed_and_thumbnail(self):
    ...
    embed.set_thumbnail(url='attachment://notifications.png')
  ...
  async def _get_wordcloud_embed_and_thumbnail(self):
    ...
    embed.set_thumbnail(url='attachment://wordcloud.png')
  ...
  async def _get_loudbot_embed_and_thumbnail(self):
    ...
    embed.set_thumbnail(url='attachment://loudbot.png')
  ...
  async def _get_dtd_embed_and_thumbnail(self):
    ...
    embed = discord.Embed(
      title='Down To Dabo',
      description=(
        'Users doing trading in <#1006265911428272239> can use the `/trade dabo` command which randomly selects a number of badges from both user inventories to swap.\n\n'
        "There's an additional command `/trade dtd` which will return a weighted randomized user from those who have opted-in to the Down To Dabo List. "
        'Select below if you would like to join or remove yourself from this list!'
      ),
      color=discord.Color(0xFF0000)
    )
    embed.set_footer(text='Please select your choice from the preference dropdown below.')
    embed.set_image(url='https://i.imgur.com/SnNqoEl.jpg')
    embed.set_thumbnail(url='attachment://dtd.png')
  ...
  async def _get_tagging_embed_and_thumbnail(self):
    ...
    embed.set_thumbnail(url='attachment://tagging.png')
  ...
  async def _get_pattern_buffer_embed_and_thumbnail(self):
    ...
    embed.set_footer(text='Please select your choice from the preference dropdown below.')
    embed.set_image(url='https://i.imgur.com/XMnho37.png')
    embed.set_thumbnail(url='attachment://buffer_dm.png')
