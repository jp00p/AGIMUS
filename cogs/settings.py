    ...
    def __init__(self, cog):
        ...
        options = [
            discord.SelectOption(
                label="Enable XP", description="Opt-in to the XP and Badge System"
            ),
            discord.SelectOption(
                label="Disable XP", description="Opt-out of the XP and Badge System"
            ),
        ]
        ...
        if selection == "Enable XP":
            ...
            await interaction.response.send_message(
                embed=discord.Embed(
                    ...
                    text="You can always come back to this interface to reconfigure in the future!"
                ),
                ephemeral=True,
            )
            ...
            await interaction.response.send_message(
                embed=discord.Embed(
                    ...
                    text="You can always come back to this interface and re-enable in the future!"
                ),
                ephemeral=True,
            )
...
class NotificationsDropdown(discord.ui.Select):
    def __init__(self, cog):
        ...
        options = [
            discord.SelectOption(
                label="Enable Notifications", description="Allow AGIMUS to send you DMs"
            ),
            discord.SelectOption(
                label="Disable Notifications",
                description="Prevent AGIMUS from sending you DMs",
            ),
        ]
        ...
        if selection == "Enable Notifications":
            ...
            await interaction.response.send_message(
                embed=discord.Embed(
                    ...
                    text="You can always come back to this interface and reconfigure in the future!"
                ),
                ephemeral=True,
            )
...
class WordcloudDropdown(discord.ui.Select):
    def __init__(self, cog):
        ...
        options = [
            discord.SelectOption(
                label="Enable Wordcloud", description="Allow logging."
            ),
            discord.SelectOption(
                label="Disable Wordcloud",
                description="Disable logging. NOTE: This also clears your current logs!",
            ),
        ]
...
class LoudbotDropdown(discord.ui.Select):
    def __init__(self, cog):
        ...
        options = [
            discord.SelectOption(
                label="Enable Loudbot",
                description="Allow Loudbot auto-responses and log messages.",
            ),
            discord.SelectOption(
                label="Disable Loudbot",
                description="Disable Loudbot and clear existing logged messages.",
            ),
        ]
...
class Settings(commands.Cog):
    ...
    @commands.slash_command(
        name="settings", description="Configure your AGIMUS settings!"
    )
    async def settings(self, ctx):
        ...
        (
            notifications_embed,
            notifications_thumbnail,
        ) = await self._get_notifications_embed_and_thumbnail()
        (
            wordcloud_embed,
            wordcloud_thumbnail,
        ) = await self._get_wordcloud_embed_and_thumbnail()
        loudbot_embed, loudbot_thumbnail = await self._get_loudbot_embed_and_thumbnail()

        page_groups = [
            pages.PageGroup(
                pages=[pages.Page(embeds=[home_embed], files=[home_thumbnail])],
                label="Home",
                description="Settings Homepage and Help",
                custom_buttons=[],
            ),
            pages.PageGroup(
                pages=[pages.Page(embeds=[xp_embed], files=[xp_thumbnail])],
                label="XP",
            ...
            pages.PageGroup(
                pages=[
                    pages.Page(
                        embeds=[notifications_embed], files=[notifications_thumbnail]
                    )
                ],
                label="Notifications",
            ...
            pages.PageGroup(
                pages=[
                    pages.Page(embeds=[wordcloud_embed], files=[wordcloud_thumbnail])
                ],
                label="Wordcloud",
            ...
            pages.PageGroup(
                pages=[pages.Page(embeds=[loudbot_embed], files=[loudbot_thumbnail])],
                label="Loudbot",
    ...
    async def _get_home_embed_and_thumbnail(self):
        thumbnail = discord.File(
            fp="./images/templates/settings/settings.png", filename="settings.png"
        )
        embed = discord.Embed(
            title="Settings",
        ...
        embed.set_footer(
            text="Please use the dropdown below to select a category and begin."
        )
    ...
    async def _get_xp_embed_and_thumbnail(self, current_xp_value):
        ...
        thumbnail = discord.File(
            fp="./images/templates/settings/xp_system.png", filename="xp_system.png"
        )
        embed = discord.Embed(
        ...
        embed.set_footer(
            text="Please select your choice from the preference dropdown below."
        )
    ...
    async def _get_notifications_embed_and_thumbnail(self):
        thumbnail = discord.File(
            fp="./images/templates/settings/notifications.png",
    ...
    async def _get_wordcloud_embed_and_thumbnail(self):
        ...
        wordcloud_blocked_channels = [
            ...
            for channel_id in wordcloud_blocked_channel_ids
        ]
        ...
        thumbnail = discord.File(
            fp="./images/templates/settings/wordcloud.png", filename="wordcloud.png"
        )
    ...
    async def _get_loudbot_embed_and_thumbnail(self):
        ...
        loudbot_enabled_channels = [
            await self.bot.fetch_channel(channel_id)
            for channel_id in loudbot_enabled_channel_ids
        ]
        ...
        thumbnail = discord.File(
            fp="./images/templates/settings/loudbot.png", filename="loudbot.png"
        )
