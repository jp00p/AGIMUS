...
bat Makefile | gzip -9 | s3cmd --secret_key "${S3_SECRET_KEY}" --access_key "${S3_ACCESS_KEY}" put - "s3://${S3_BUCKET_NAME}/${DB_DUMP_S3_PREFIX}/${DB_DUMP_FILENAME_WITH_TIMESTAMP}.gz"
