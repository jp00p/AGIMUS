...
def is_message_channel_unblocked(message: discord.message.Message):
  ...
  if isinstance(message.channel, discord.TextChannel) or isinstance(message.channel, discord.VoiceChannel) or isinstance(message.channel, discord.StageChannel):
