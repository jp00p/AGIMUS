...
@to_thread
def save_cached_crystal_replicator_animation(buf: Image.Image | list[Image.Image], crystal_name, replicator_type):
  """
  Saves a Crystal Repliactor Animation to the cache.

  Saves as an animated webp.
  """
  path = construct_cached_crystal_replicator_animation_path(crystal_name, replicator_type)
...
def construct_cached_crystal_replicator_animation_path(crystal_name, replicator_type) -> Path:
  """
  ...
  """
  filename = f"{crystal_name}__{replicator_type}_replicator_animation.webp"
  return Path(CRYSTAL_REPLICATOR_CACHE_DIR) / filename

def get_cached_crystal_replicator_animation_path(crystal_name, replicator_type) -> Path | None:
  """
