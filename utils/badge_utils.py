...
#         \/     \/               \/             \/|__|             \/                    \/
# async def generate_paginated_set_completion_images(user:discord.User, type, all_rows, total_badges, title, collected, filename_prefix):
#   max_per_image = 5
